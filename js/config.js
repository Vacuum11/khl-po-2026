...
const BRACKET = {
  ...
  west: {
    ...
    r1: [
      ...
      { id: "w2", home: "Динамо Минск",   away: "Динамо Москва"   },  // 4 vs 5
      { id: "w3", home: "Северсталь",     away: "Торпедо"   },  // 2 vs 7
      { id: "w4", home: "ЦСКА",           away: "СКА"  }   // 3 vs 6
    ]
  },
  east: {
    name: "Восток",
    r1: [
      ...
      { id: "e2", home: "Авангард",      away: "Нефтехимик"    },  // 4 vs 5
      { id: "e3", home: "Ак Барс",       away: "Трактор"    },  // 2 vs 7
      { id: "e4", home: "Автомобилист",  away: "Салават Юлаев"       }   // 3 vs 6
    ]
  }
};
